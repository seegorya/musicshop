    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            try
            {
                ...
                {
                    // Initialization.    
                    var loginInfo = this.db.LoginByUsernamePassword(model.login, model.password).ToList();
                    // Verification.    
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                {
                    // Initialization.    
                    var regInfo = this.db.Insert_User(model.login, model.contacts, model.Password).ToList();
                    // Verification.    
                    ...
                    {
                        ModelState.AddModelError(string.Empty, "This login is already taken! Try another one.");
                    }
                }
            }
            catch (Exception ex)
